                            ...
                            const xmlChar **attr)
{
    ...
    strcpy_s(&(simpleXml->elementPath[simpleXml->elementPathLen]), sizeof(simpleXml->elementPath)-simpleXml->elementPathLen, name);//zwx367245 2016.10.08 第二个参数长度太长，可能存在溢出。
...
//lint -e121
//static struct _xmlSAXHandler saxHandlerG =  by zwx367245 2016.10.21
